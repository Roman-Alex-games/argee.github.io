...
[
	...
	{name:"TBEN-L4-16DXP",slice_list:[0x01500028,0x816D5500],order_num:6814012},		
	{name:"TBEN-L1-8DIP-8DOP",slice_list:[0x01510028,0x615B4400],order_num:6814006},
	{name:"TBEN-L4-8DIP-8DOP",slice_list:[0x01500028,0x615B4400],order_num:6814010},
	...
	{name:"TBEN-S1-4DIP-4DOP",slice_list:[0x01500021,0x40533300],order_num:6814021},
	{name:"TBEN-S1-8DXP",slice_list:[0x01500021,0x60554400],order_num:6814023},
...
function sim_GetIO_And_PLC_Vars(req_code,req_len,dt,offset)
{
	...
	if ((flags_and_retain_addr&(1<<31))!=0)
	{
		dt.setUint32(offset,sim_curr_trace_pos,true);offset+=4;
...
{
	var tmp_dt=GOM_CreateRespArr(4);
	tmp_dt.setUint32(0,0x02040000,true);
}
