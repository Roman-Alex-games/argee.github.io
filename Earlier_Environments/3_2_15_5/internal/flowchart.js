...
function generateARGEE_Code(upload)
{
	...
	func_blocks[0].values[0]=default_task_type;
	func_blocks[0].values[1]=1;
	var code_elem=func_blocks[0].sub_elems[0].sub_elems;
	func_blocks[0].sub_elems.splice(1,1);
...
function fillInputs()
{
	...
	flowchart_inputs[flowchart_inputs.length]={type:elem_type._inp,name:"PLC In Reg 1",elem_type:data_type._bool,act_data:"plc_out_reg1",var_type:var_type.plc,add_info:[0]};
	flowchart_inputs[flowchart_inputs.length]={type:elem_type._inp,name:"PLC In Reg 2",elem_type:data_type._bool,act_data:"plc_out_reg2",var_type:var_type.plc,add_info:[1]};
...
/*		tbl+="<td>";
		...
		tbl+="</td>";*/
		tbl+="<td>";
		tbl+="Timer "+(i+1)+" Expiration (in milliseconds): "+"<input type=\"text\" value=\""+flowchart.timer_exp[i]+"\" onchange=\"FLOW.elemNumChange(this,'flowchart.timer_exp',"+i+")\">";
		tbl+="</td>";
		tbl+="<td>";
		tbl+="Counter "+(i+1)+" - Count From 0 To: "+"<input type=\"text\" value=\""+flowchart.counter_preset[i]+"\" onchange=\"FLOW.elemNumChange(this,'flowchart.counter_preset',"+i+")\">";
		tbl+="</td>";
		tbl+="</tr>";
	}
	tbl+="</table>";
