...
function savePrevCompilerMessage()
{
	...
	{
		var table_row=document.getElementById("status_row");
		table_row.deleteCell(0);
		var status_cell=document.getElementById("status_cell");
		status_cell.colSpan=2;
		var res_id=document.getElementById("comp_res_id");
		res_id.style.textAlign="right"
		prev_compiler_message=comp_res.innerHTML;
	}
}
...
function restorePrevCompilerMessage()
{
	...
	{
		var status_cell=document.getElementById("status_cell");
		status_cell.colSpan=1;
		var table_row=document.getElementById("status_row");
		table_row.insertCell(0);
		var res_id=document.getElementById("comp_res_id");
		res_id.style.textAlign="center"
		comp_res.innerHTML=prev_compiler_message;
