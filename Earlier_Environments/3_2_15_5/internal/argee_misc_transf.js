...
function setupWindowEnvironment()
{
	...
	nav_div.innerHTML="<table id=\"nav_table\" style=\"width:99%;table-layout:fixed;\"><tr><td><div id=\"nav_prj_name\"></div></td><td></td><td><div id=\"nav_dev\"></div></td></tr><tr><td colspan=\"3\"><div id=\"nav_inner\"></div></td></tr><tr id=\"status_row\"><td></td><td id=\"status_cell\" valign=\"top\"><div style=\"text-align: center;\" id=\"comp_res_id\"></div></td><td><div align=\"right\" id=\"checksum\"></div></td></tr></table>";
	...
	checksum_div.style.overflow="hidden";
...
//	SIM.preprocessProjFile(GOM.createProjFile(prj_obj_list_curr));
	...
	yield* GOM.objectExchange(GOM.createProjFile(prj_obj_list_curr),0,"STORE_ARGEE_FILE",false);
	...
	{
		setCompilerMessage(false,false,"Project loaded into an empty device. Wait for 20 seconds before switching to test");
	}
