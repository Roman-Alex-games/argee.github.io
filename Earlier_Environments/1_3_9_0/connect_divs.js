...
{
	saveLocal();
	/*localStorage.flowchart_rungs=JSON.stringify(rungs);
	localStorage.flowchart_const=JSON.stringify(constants);
	localStorage.flowchart_timer_exp=JSON.stringify(timer_exp);
	localStorage.flowchart_counter_preset=JSON.stringify(counter_preset);*/
}
/*
function loadFlowchart()
{
	if ((localStorage.flowchart_rungs==undefined)||
	    (localStorage.flowchart_const==undefined)||
		(localStorage.flowchart_timer_exp==undefined)||
		(localStorage.flowchart_counter_preset==undefined))
	{
		return false;
	}
	rungs=JSON.parse(localStorage.flowchart_rungs);
	constants=JSON.parse(localStorage.flowchart_const);
	timer_exp=JSON.parse(localStorage.flowchart_timer_exp);
	counter_preset=JSON.parse(localStorage.flowchart_counter_preset);
	return true;
}*/
...
{
	// generate variables
	var_db[0].var_list[0]={name:"reg1"};
	var_db[0].var_list[1]={name:"reg2"};
	var_db[1].var_list[0]={name:"tm1"};
	var_db[1].var_list[1]={name:"tm2"};
	var_db[1].var_list[2]={name:"cnt1"};
	var_db[1].var_list[3]={name:"cnt2"};
	
	var_db[3].var_list[0]={name:"plc_in_reg1",section:0,word_index:0, bit_offset:0, size:0,signed:0};
	var_db[3].var_list[1]={name:"plc_in_reg2",section:0,word_index:1, bit_offset:0, size:0,signed:0};
	var_db[3].var_list[2]={name:"plc_out_reg1",section:1,word_index:0, bit_offset:0, size:0,signed:0};
	var_db[3].var_list[3]={name:"plc_out_reg2",section:1,word_index:1, bit_offset:0, size:0,signed:0};
...
function getTimerCnt_Count(elem)
{
	...
	{
		tmp=getVarValue(var_type.timer,elem.act_data+1,3);
	}
	else
	{
		tmp=getVarValue(var_type.timer,elem.act_data-1,3);
...
function getTimerCnt_Done(elem)
{
	...
	if (elem.elem_type==data_type._ctu)
	{
		tmp=getVarValue(var_type.timer,elem.act_data+1,0);
	}
	else
	{
		tmp=getVarValue(var_type.timer,elem.act_data-1,0);
	...
	if (elem.var_type!=undefined)
	{
		switch(elem.var_type)
		{
			case var_type.prog:
				  ...
				  return val;
			case var_type.timer:
				  var tmp=getVarValue(var_type.timer,elem.add_info[0],0);
				  var done=(tmp>>8)&1;
				  return done;
			case var_type.io:
				  var ind=findIndex(IO[elem.add_info[0]]);
...
function fillInputs()
{
	flowchart_inputs=[];
	fillIO_Inputs();
	flowchart_inputs[flowchart_inputs.length]={type:elem_type._inp,name:"Timer 1 expired",elem_type:data_type._bool,act_data:"expired(tm1)",var_type:var_type.timer,add_info:[0]};
	flowchart_inputs[flowchart_inputs.length]={type:elem_type._inp,name:"Timer 2 expired",elem_type:data_type._bool,act_data:"expired(tm2)",var_type:var_type.timer,add_info:[1]};
	flowchart_inputs[flowchart_inputs.length]={type:elem_type._inp,name:"Counter 1 expired",elem_type:data_type._bool,act_data:"expired(cnt1)",var_type:var_type.timer,add_info:[2]};
	flowchart_inputs[flowchart_inputs.length]={type:elem_type._inp,name:"Counter 2 expired",elem_type:data_type._bool,act_data:"expired(cnt2)",var_type:var_type.timer,add_info:[3]};
	

	flowchart_inputs[flowchart_inputs.length]={type:elem_type._inp,name:"Internal Reg 1",elem_type:data_type._bool,act_data:"reg1",var_type:var_type.prog,add_info:[2]};
	flowchart_inputs[flowchart_inputs.length]={type:elem_type._inp,name:"Internal Reg 2",elem_type:data_type._bool,act_data:"reg2",var_type:var_type.prog,add_info:[3]};
	
	
	flowchart_inputs[flowchart_inputs.length]={type:elem_type._inp,name:"PLC In Reg 1",elem_type:data_type._bool,act_data:"plc_out_reg1",var_type:var_type.plc,add_info:[2]};
	flowchart_inputs[flowchart_inputs.length]={type:elem_type._inp,name:"PLC In Reg 2",elem_type:data_type._bool,act_data:"plc_out_reg2",var_type:var_type.plc,add_info:[3]};
	flowchart_inputs[flowchart_inputs.length]={type:elem_type._inp,name:"Zero",elem_type:data_type._bool,act_data:"0"};
	flowchart_inputs[flowchart_inputs.length]={type:elem_type._inp,name:"False",elem_type:data_type._bool,act_data:"0"};
	flowchart_inputs[flowchart_inputs.length]={type:elem_type._inp,name:"True",elem_type:data_type._bool,act_data:"1"};
...
function fillOutputs()
{
   ...
   flowchart_outputs[flowchart_outputs.length]={type:elem_type._outp,name:"No Action",elem_type:data_type.no_act,act_data:""};
	...
	flowchart_outputs[flowchart_outputs.length]={type:elem_type._outp,name:"PLC Out Reg 1",elem_type:data_type._bool,act_data:"plc_in_reg1",var_type:var_type.plc,add_info:[0]};
	flowchart_outputs[flowchart_outputs.length]={type:elem_type._outp,name:"PLC Out Reg 2",elem_type:data_type._bool,act_data:"plc_in_reg2",var_type:var_type.plc,add_info:[1]};	
}
