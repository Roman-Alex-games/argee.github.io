...
[
	...
	{name:"ARRAY_INIT",arg_types:["@INT","INT","@INT",null],func_num:51       ,ret_type:"INT",const_arr_type:"INT"},
	...
	{name:"ARRAY_INIT_BYTE",arg_types:["@BYTE","INT","@BYTE",null],func_num:51       ,ret_type:"INT",const_arr_type:"BYTE" }, // same function code as ARRAY_INIT
	{name:"ARRAY_INIT_WORD",arg_types:["@WORD","INT","@WORD",null],func_num:51       ,ret_type:"INT",const_arr_type:"WORD"}, // same function code as ARRAY_INIT
	{name:"BASE64_ENCODE",arg_types:["@BYTE","INT","@BYTE",null],func_num:57       ,ret_type:"INT"},   
...
var hmi_conv_tbl=
[
	{func:"DISPLAY_VALUE",replace_spaces_in_title:true,colspan_2_if_title_empty:true,bg_color_elem:5,output_func:"HMI_GRID_SHOW",args:[1],title_pos:0,format:[["<font size='",4,"' color='",3,"'>",0,"</font>"],["<font size='",4,"' color='",3,"'><table style=\"border-spacing:0px;\"><tr><td>",{},"</td><td>",2,"</td></tr></table></font>"]]},
//	{func:"DISPLAY_VALUE",replace_spaces_in_title:true,colspan_2_if_title_empty:true,bg_color_elem:5,output_func:"HMI_GRID_SHOW",args:[1],title_pos:0,format:[["<font size='",4,"' color='",3,"'>",0,"</font>"],["<font size='",4,"' color='",3,"'><table><tr><td>",{},"</td><td>",2,"</td></tr></table></font>"]]},
	{func:"ENTER_VALUE",replace_spaces_in_title:true,colspan_2_if_title_empty:true,bg_color_elem:5,output_func:"HMI_GRID_ENTER",args:[1],title_pos:0,format:[["<font size='",4,"' color='",3,"'>",0,"</font>"],["<font size='",4,"' color='",3,"'><table><tr><td>",{},"</td><td style='padding-left:3px;'>",2,"</td></tr></table></font>"]]},	
	{func:"BUTTON",bg_color_elem:4,output_func:"HMI_GRID_BUTTON",args:[0,1],title_pos:0,format:[[],["<font size='",3,"' color='",2,"'>",{},"</font>",]]},		
	{func:"STATIC_TEXT",replace_spaces_in_title:true,bg_color_elem:3,align_arg:4,title_pos:0,format:[[],["<font size='",2,"' color='",1,"'>",0,"</font>"]]},			
	{func:"STATIC_GRAPHICS",bg_color_elem:1,output_func:"HMI_GRAPHICS",args:[0,2],title_pos:0,format:[[],[{}]]},			
	{func:"SCREEN_LIST",title_pos:0,output_func:"HMI_SCREEN_LIST",args:[],format:[[],["<fieldset><table><tr><td><center><font size='",1,"' color='",2,"'>",0,"</font></center></td></tr><tr><td><center><font size='",1,"' >",{},"</font></center></td></tr></table></fieldset>"]]},				
	{func:"MULTI_STATE_DISPLAY_STRING",replace_spaces_in_title:true,colspan_2_if_title_empty:true,bg_color_elem:4,output_func:"HMI_MULTI_STATE_SHOW",args:[1,2,-5],title_pos:0,format:[["<font size='",2,"' color='",3,"'>",0,"</font>"],["<font size='",2,"'>",{},"</font>"]]},	
	{func:"MULTI_STATE_DISPLAY_GRAPHICS",replace_spaces_in_title:true,colspan_2_if_title_empty:true,bg_color_elem:4,output_func:"HMI_MULTI_STATE_GRAPHICS",args:[1,-5],title_pos:0,format:[["<font size='",2,"' color='",3,"'>",0,"</font>"],[{}]]},	
	{func:"DROPDOWN_LIST",colspan_2_if_title_empty:true,bg_color_elem:4,output_func:"HMI_MULTI_STATE_ENTER",args:[1,-5],title_pos:0,format:[["<font size='",2,"' color='",3,"'>",0,"</font>"],["<font size='",2,"'>",{},"</font>"]]},		
	{func:"DISPLAY_VALUE_WITH_HEALTH",replace_spaces_in_title:true,colspan_2_if_title_empty:true,output_func:"HMI_DISPLAY_VALUE_WITH_HEALTH",args:[3,4,5],title_pos:0,format:[["<font size='",2,"' color='",1,"'>",0,"</font>"],["<font size='",2,"'>",{},"</font>"]]},	
	{func:"LINK",output_func:"HMI_GRID_LINK",args:[0,1,2],title_pos:0,format:[[],["<font size='",3,"'>",{},"</font>",]]},		
   {func:"LOAD_FROM_FILE",replace_spaces_in_title:true,colspan_2_if_title_empty:true,output_func:"HMI_GRID_LOAD_FROM_FILE",args:[0,1,2,3,4,5],title_pos:0,format:[["<font size='",7,"' color='",6,"'>",0,"</font>"],["<font size='",7,"' color='",6,"'><table><tr><td>",{},"</td></tr></table></font>"]]},			
	{func:"STORE_TO_FILE",replace_spaces_in_title:true,colspan_2_if_title_empty:true,output_func:"HMI_GRID_STORE_TO_FILE",args:[0,1,2,3,4],title_pos:0,format:[["<font size='",6,"' color='",5,"'>",0,"</font>"],["<font size='",6,"' color='",5,"'><table><tr><td>",{},"</td></tr></table></font>"]]},			
