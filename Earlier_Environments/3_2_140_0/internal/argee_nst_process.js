...
[
   ...
   // hidden functions for LADDER "COIL" and "ASSIGNMENT" operating  on IO/PLC variables 
  	{name:"LADDER_COIL_SPECIAL",arg_types:["INT","INT","INT",null],func_num:11       ,ret_type:"INT"},
	{name:"LADDER_ASSIGN_SPECIAL",arg_types:["INT","INT","INT","INT"],func_num:12       ,ret_type:"INT"},
   {name:"LADDER_ASSIGN_SPECIAL_FP",arg_types:["&INT","INT","INT","INT"],func_num:12       ,ret_type:"INT"},
   ...
   {name:"SET_PLC_OUTP_INT",arg_types:["INT","INT","INT",null],func_num:60       ,ret_type:"INT"},   
