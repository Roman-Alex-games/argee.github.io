	...
	for(i=0;i<prj.list[1].list.length;i++)
	{
				 ...
				 )
		{
			...
			if (prj.list[1].list[i].enum_type==ELEM.TASK)
			{
				...
				prj_elems.sub_elems[curr_module].sub_elems[prj_elems.sub_elems[curr_module].sub_elems.length-2].values[1]=1;	
			}
			else if (prj.list[1].list[i].enum_type==ELEM.FUNCT_BLOCK)
			{
				prj_elems.sub_elems[curr_module].sub_elems[prj_elems.sub_elems[curr_module].sub_elems.length-2].values[1]=0;	
			}
