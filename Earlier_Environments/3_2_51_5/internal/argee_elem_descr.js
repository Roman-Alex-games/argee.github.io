	...
	function preRenderProg(elem,index,parent,funct_block_index)
	{
		...
		if (descr.screens.indexOf(screens.prog_scr)!=-1)
		{
			...
			else
			{
				...
				{
					var render_border;
					if (((elem.sub_elems!=undefined)||(descr.render_text_area==true))&&(descr.dont_render_border!=true))
					{
						render_border=true;
					}
					else
		...
		for(i=0;i<pre_render_buf.length;i++)
		{
			...
			if (((pre_render_buf[i].descr.type==block_types.funct_block_def)||(pre_render_buf[i].descr.type==block_types.hmi_screens)||(pre_render_buf[i].descr.type==block_types.function_block_group_def)))
			{
				if (i>0)
				{
					...
					{
						str+="<td colspan=\"2\" height=\"30px\" width=\"10px\" style=\"border-left: 1px solid transparent;border-top: 1px solid black;border-right: 0px solid transparent;border-bottom: 1px solid black;\" ><hr style=\"border-width:1px;\"></td>";
					}
					else
					{
						str+="<td colspan=\"2\" height=\"30px\" width=\"10px\" style=\"border-left: 1px solid transparent;border-top: 1px solid transparent;border-right: 0px solid transparent;\" ><hr style=\"border-width:1px;\"></td>";
					}
